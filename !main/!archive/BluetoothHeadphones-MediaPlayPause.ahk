...
Menu, Tray, Icon, DDORes.dll, 3

;-=-=-=- * * * -=-=-=-

#Include <AHKHID>

OnMessage(0xFF, "InputMsg") ; 0xFF : WM_INPUT
AHKHID_Register(12, 1, A_ScriptHwnd, RIDEV_INPUTSINK)
return

; See:
; https://autohotkey.com/boards/viewtopic.php?t=13337
; https://www.reddit.com/r/AutoHotkey/comments/4xdpch
;
InputMsg(wParam, lParam) {
	...
	;Get device type
	if (AHKHID_GetInputInfo(lParam, II_DEVTYPE) <> RIM_TYPEHID)
		return 0
	...
	; 01B0000000 - Play
	; 01B1000000 - Pause
	If (h = "01B0000000") OR (h = "01B1000000") {
