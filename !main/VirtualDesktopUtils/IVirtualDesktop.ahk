; AHK interface for IVirtualDesktopManager
; -- by flipeador (Matias Juarez)
;
; From:
; - https://www.autohotkey.com/boards/viewtopic.php?p=64435#p64435
; - https://github.com/flipeador/Library-AutoHotkey/blob/master/sys/IVirtualDesktopManager.ahk
; - https://github.com/flipeador/Library-AutoHotkey/blob/285522bd6885874da36cdd8473eb6938fd486a8c/sys/IVirtualDesktopManager.ahk
; 
; See also:
...
Class IVirtualDesktopManager
{
	__New()
	{
		...
		; See, https://msdn.microsoft.com/en-us/library/windows/desktop/mt186440(v=vs.85).aspx
